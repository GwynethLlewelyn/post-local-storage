...
However, since having found that GitHub _will_ deal with automatically creating the zip file _without* even needing an intermediate step when packaging everything together. My new command is now:
